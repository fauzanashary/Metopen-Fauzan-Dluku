<div class="row">
    ...
    <div class="btn-group mb-3">
        ...
        <button wire:click="belumDipinjam" class="btn btn-sm bg-indigo mr-2">Belum Dibayar</button>
        <button wire:click="sedangDipinjam" class="btn btn-sm bg-olive mr-2">Sedang Diproses</button>
        <button wire:click="selesaiDipinjam" class="btn btn-sm bg-fuchsia mr-2">Pesanan Selesai</button>
    </div>
                ...
                @foreach ($transaksi as $item)
                    <tr>
                       ...
                       <td>
                        ...
                        <td>
                            @if ($item->status == 1)
                                <span class="badge bg-indigo">Belum Dibayar</span>
                            @elseif ($item->status == 2)
                                <span class="badge bg-olive">Sedang Diproses</span>
                            @else
                                <span class="badge bg-fuchsia">Pesanan Selesai</span>
                            @endif
                        </td>
                       @if (!$selesai_dipinjam)
                            <td>
