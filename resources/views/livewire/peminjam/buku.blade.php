<div class="container">
            ...
            <div class="col-md-4">
              <label class="sr-only" for="inlineFormInputGroup">Username</label>
                <div class="input-group mb-2">
                  <input wire:model="search" type="text" class="form-control" id="inlineFormInputGroup" placeholder="Cari Makanan">
    ...
    @if ($detail_buku)
        ...
        <div class="row">
            <div class="col-md-4">
                <img src="/{{$buku->sampul}}" alt="{{$buku->judul}}" width="300" height="400">
            </div>
            <div class="col-md-8">
                 <table class="table">
                  <tbody>
            ...
            <div class="row">
                @foreach ($buku as $item)
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        ...
                        <img src="/{{$item->sampul}}" class="card-img-top" alt="{{$item->judul}}" width="200" height="300">
                        <div class="card-body">
